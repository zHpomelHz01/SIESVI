...
# s3.Bucket('bucket-models-siesvi').download_file('RandomForest 1x1.pkl', Filename='/tmp/{}'.format('RandomForest 1x1.pkl'))
# model = pickle.load(open('/tmp/model.pkl', 'rb'))
# s3.meta.client.download_file(Bucket='bucket-models-siesvi',Key='RandomForest 1x1.pkl',Filename='/tmp/RandomForest 1x1.pkl')
# my_modelo = pickle.load(open('/tmp/RandomForest 1x1.pkl', 'rb'))
# my_modelo = pickle.loads(s3.Bucket("bucket-models-siesvi").Object('RandomForest 1x1 - pickle.pkl').get()['Body'].read())
# with BytesIO() as data:
#    s3.Bucket('bucket-models-siesvi').download_fileobj('RandomForest 1x1 - pickle.pkl', data)
#    data.seek(0)    # move back to the beginning after writing
#    my_modelo = pickle.load(data)
...
def variablesClima(lat, lon):
    url = 'https://api.openweathermap.org/data/2.5/weather?lat={}&lon={}&appid=de50aee36fb362c12224b73cc5d1c876&units=metric'.format(
        lat, lon)
